...
public class TennerDice : MonoBehaviour
{
    ...
    public void OnStopped()
    {
        ...
        int diceRoll = DiceRollCalculator.CalculateDiceRollTen();
        ...
        GameObject.Find("AttackHolder").GetComponent<AttackHolder>().AddAttack(diceRoll, "Tenner", diceRoll);
    }
    ...
    private void FreezeOnRoll(int num)
    {
        ...
        DiceType myDiceType = DiceManager.SearchDiceType("Tenner");
